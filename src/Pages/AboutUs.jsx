    ...
    <>
      <div className=" bg-white pb-40">
        ...
        <div className=" relative flex flex-col justify-center items-center">
          ...
          <h3 className=" absolute top-1/2 left-20 z-20 text-black text-5xl font-black hover:cursor-pointer parent">About Us</h3>
        </div>
        ...
        <div className=" grid md:grid-cols-2 lg:grid-cols-4 justify-items-center mb-20">
          ...
          <div className = "flex flex-col justify-center items-center my-5">
            ...
            <h3 className=" text-2xl font-bold text-zinc-700" >Superior Quality</h3>
          </div>
          <div className = "flex flex-col justify-center items-center my-5">
        ...
        <div className=" block md:relative md:flex md:justify-start md:items-center md:mb-60">
          ...
          <div className=" w-full md:w-1/2 h-auto bg-zinc-300 z-10 md:absolute md:top-52 md:right-0">
            <div className=" grid grid-cols-2 justify-items-center py-20">
              <div className=" flex flex-col justify-center items-center my-10">
                <h3 className=" text-5xl text-black font-bold">8480</h3>
                <p className=" text-xl text-black font-light">Happy Customers</p>
              </div>
              <div className=" flex flex-col justify-center items-center my-10">
