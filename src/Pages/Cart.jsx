    ...
    <>
        <div className=" bg-white pb-20">
            ...
            <div className=" text-center w-screen h-auto text-lg text-black mt-28 hover:cursor-pointer font-light">
                <span onClick = {() => { history.push("/")}}>Home /</span><span onClick = {() => { history.push("/Cart")}}> Cart</span>
            </div> 
            ...
            <div className=" grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-5 gap-y-2 justify-items-center ml-5 mr-5">
                ...
                <div className=" m-4 relative p-4">
                    ...
                    />
                    <form className=" my-2">
                        <input type="number" name="Quantity" placeholder="Quantity" className="w-full border-2 border-slate-400 h-10 pl-3"/>
                    </form>
                    <div className=" flex justify-center items-center">
                        <Button text = "REMOVE" className=" hover:border-2 hover:border-black h-10 w-[200px] mt-2 mb-5 font-bold text-md hover:text-black hover:bg-white bg-black text-white  transition-all duration-700 "/> 
                    </div>
            </div>
          );
        })}
